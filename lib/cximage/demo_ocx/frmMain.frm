...
Begin VB.MDIForm frmMain 
   ...
   Begin VB.Menu mnuCxImage 
      ...
      Begin VB.Menu sep1 
         Caption         =   "-"
      End
      Begin VB.Menu RotateLeft 
         Caption         =   "RotateLeft"
      End
      Begin VB.Menu RotateRight 
         Caption         =   "RotateRight"
      End
      Begin VB.Menu sep2 
         Caption         =   "-"
...
Private Sub Dither_Click()
    If Not (ActiveForm Is Nothing) Then
        ActiveForm.AxImage1.Dither 0
        ActiveForm.AxImage1.Refresh
    End If
End Sub

Private Sub Emboss_Click()
    If Not (ActiveForm Is Nothing) Then
        Dim kernel(0 To 8) As Long
        kernel(0) = 1
        kernel(1) = 0
        kernel(2) = 0
        kernel(3) = 0
        ...
        kernel(7) = 0
        kernel(8) = -1
        ActiveForm.AxImage1.Filter kernel(0), 3, 0, 127
        ActiveForm.AxImage1.Refresh
    End If
End Sub
...
Private Sub Filter_Click()
    If Not (ActiveForm Is Nothing) Then
        ...
        kernel(7) = -1
        kernel(8) = -1
        ActiveForm.AxImage1.Filter kernel(0), 3, 0, 0
        ActiveForm.AxImage1.Refresh
    End If
End Sub
...
Private Sub RotateLeft_Click()
    If Not (ActiveForm Is Nothing) Then
        ActiveForm.AxImage1.RotateLeft
        ActiveForm.AxImage1.Refresh
    End If
End Sub
...
Private Sub RotateRight_Click()
    If Not (ActiveForm Is Nothing) Then
        ActiveForm.AxImage1.RotateRight
        ActiveForm.AxImage1.Refresh
    End If
End Sub
...
Private Sub mnuFileSaveAs_Click()
    ...
    dot = InStr(1, sFile, ".", vbTextCompare)
    If dot > 0 Then sExt = LCase(Mid(sFile, dot + 1, 3))
    filetype = ActiveForm.AxImage1.StringToFormat(sExt)
    If filetype <> 0 Then
        ActiveForm.Caption = sFile
        ActiveForm.AxImage1.Save sFile, filetype
    End If
...
Private Sub mnuFileOpen_Click()
    ...
    If sExt <> "" Then
        ActiveForm.Caption = sFile
        'ActiveForm.AxImage1.SetFrame 1
        ActiveForm.AxImage1.Load sFile, filetype
        ActiveForm.AxImage1.Stretch = False
        ActiveForm.AxImage1.Refresh
    End If
